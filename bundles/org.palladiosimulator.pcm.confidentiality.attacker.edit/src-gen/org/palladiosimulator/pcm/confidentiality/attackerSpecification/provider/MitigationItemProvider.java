		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mitigation_necessaryCredentials_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mitigation_necessaryCredentials_feature", "_UI_Mitigation_type"),
				 AttackerPackage.Literals.MITIGATION__NECESSARY_CREDENTIALS,
				 true,
				 false,
				 true,
				 null,
